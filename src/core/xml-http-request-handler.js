...
function customXMLHttpRequest() {
  ...
  newXMLHttpRequest.addEventListener(
    'abort',
    function () {
...
export function captureXMLHttpRequest(tracker) {
  ...
  window.addEventListener('ajaxLoadStart', function (e) {
    ...
    const xmlHttpRequestLog = new Log(
      tracker.trackerOptions,
      'XMLHttpRequest Log',
      loadStartLog,
      tracker.sessionId,
      tracker.trackerOptions.customizeXMLHttpRequestLog(e)
    );
    tracker.logList.push(xmlHttpRequestLog);

    console.debug('XMLHttpRequest Traking Log:\n', xmlHttpRequestLog);
  });
